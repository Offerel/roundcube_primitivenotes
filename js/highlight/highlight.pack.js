...
contains:a,keywords:e,illegal:"\\S"}}})());hljs.registerLanguage("scilab",(()=>{"use strict";return e=>{
...
end:"\\][\\.']*",relevance:0,contains:n},e.COMMENT("//","$")].concat(n)}}})());hljs.registerLanguage("awk",(()=>{"use strict";return e=>({name:"Awk",keywords:{
...
},e.REGEXP_MODE,e.HASH_COMMENT_MODE,e.NUMBER_MODE]})})());hljs.registerLanguage("javascript",(()=>{"use strict"
...
begin:"\\."+n.IDENT_RE,relevance:0},a,t,i],illegal:/#/}}})());hljs.registerLanguage("leaf",(()=>{"use strict";return e=>({name:"Leaf",
...
end:'"'},{className:"variable",begin:"[A-Za-z_][A-Za-z_0-9]*"}]}]}]})})());hljs.registerLanguage("sml",(()=>{"use strict";return e=>({
...
relevance:0},{begin:/[-=]>/}]})})());hljs.registerLanguage("gml",(()=>{"use strict";return e=>({name:"GML",
...
begin:t,end:a,contains:[n],relevance:5}])}}})());hljs.registerLanguage("sql_more",(()=>{"use strict";return e=>{
...
name:"TypeScript",aliases:["ts"]}),b}})());hljs.registerLanguage("autoit",(()=>{"use strict";return e=>{const t={
...
contains:[r,i,n]}]}]}}})());hljs.registerLanguage("tcl",(()=>{"use strict";return e=>({name:"Tcl",
aliases:["tk"],
...
variants:[e.BINARY_NUMBER_MODE,e.C_NUMBER_MODE]}]})})());hljs.registerLanguage("groovy",(()=>{"use strict";function e(e,n={}){
...
className:"class",beginKeywords:"enum class struct union",end:/[{;:<>=]/,
contains:[{beginKeywords:"final class struct"},t.TITLE_MODE]}]),exports:{
preprocessor:c,strings:s,keywords:u}}}})());hljs.registerLanguage("ldif",(()=>{"use strict";return e=>({name:"LDIF",
...
end:"$"},e.HASH_COMMENT_MODE]})})());hljs.registerLanguage("nginx",(()=>{"use strict";return e=>{const n={
...
end:/$/}]})})());hljs.registerLanguage("pony",(()=>{"use strict";return e=>({name:"Pony",
keywords:{
...
relevance:0},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]})})());hljs.registerLanguage("php",(()=>{"use strict";return e=>{const r={
className:"variable",
...
skip:!0})]}]})})());hljs.registerLanguage("stylus",(()=>{"use strict";return e=>{var t={
...
illegal:/\./,relevance:0}}]}}})());hljs.registerLanguage("autohotkey",(()=>{"use strict";return e=>{const a={
...
begin:"A_[a-zA-Z0-9]+"},{begin:",\\s*,"}]}}})());hljs.registerLanguage("perl",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
...
r.name="Arduino",r.aliases=["ino"],r.supersetOf="cpp",r}})());hljs.registerLanguage("pgsql",(()=>{"use strict";return E=>{
...
begin:/\{/,end:/\}/,skip:!0}].concat(g)},v]}}})());hljs.registerLanguage("stata",(()=>{"use strict";return e=>({name:"Stata",
...
end:/$/,keywords:{$pattern:/[\.\w]+/,"meta-keyword":".PHONY"}},r]}}})());hljs.registerLanguage("xl",(()=>{"use strict";return e=>{const t={
...
subLanguage:"vbscript"}]})})());hljs.registerLanguage("erlang",(()=>{"use strict";return e=>{
...
starts:{end:/$/,contains:[i,c,r,t,l,a]}}]}}})());hljs.registerLanguage("r",(()=>{"use strict";function e(...e){return e.map((e=>{
...
begin:"^Content",end:":",excludeEnd:!0}]})})());hljs.registerLanguage("nix",(()=>{"use strict";return e=>{const n={
...
aliases:["nixos"],keywords:n,contains:t}}})());hljs.registerLanguage("properties",(()=>{"use strict";return e=>{
